...
/**
 * Servlet implementation class ItemCadastrarServlet
 */
@WebServlet("/ItemCadastrarServlet")
public class ItemCadastrarServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ItemCadastrarServlet() {
        super();
